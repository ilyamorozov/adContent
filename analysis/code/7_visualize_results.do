...
program demand_rotation_genre
	...
	* Visualize averages *
	...
	graph export "../output/graphs/demand_rotation/fig4a_rotation_levels_genre.pdf", replace
	graph close
	...
	* Visualize ATE on search rates *
	...
	graph export "../output/graphs/demand_rotation/rotation_ate_genre.pdf", replace
	graph close
...
program demand_rotation_price
	...
	* Visualize averages *
	...
	graph export "../output/graphs/demand_rotation/fig4b_rotation_levels_price.pdf", replace
	graph close
	...
	* Visualize ATE on search rates *
	...
	graph export "../output/graphs/demand_rotation/rotation_ate_price.pdf", replace
	graph close
...
program descriptive_histograms
	...
	* Time spent in the store *
	...
	graph export "../output/graphs/descriptives/figA3a_histogram_duration.pdf", replace
	...
	* Pages opened *
	...
	graph export "../output/graphs/descriptives/figA3b_histogram_pages.pdf", replace
	graph close
...
program plot_spatial_spillovers	   
	...
	* ATE spillovers (lost girls + purchases) *
	...
	graph export "../output/graphs/figA6a_spillovers_by_rank1.pdf", replace
	graph close
	...
	* ATE spillovers (stateline + purchases) *
	...
	graph export "../output/graphs/figA6b_spillovers_by_rank2.pdf", replace
	graph close
	drop position* ad_position* ad_other outcome
